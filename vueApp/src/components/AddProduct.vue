            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input v-model="ProductName" class="form-control form-control-sm" name="ProductName" id="ProductName"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input v-model="Color" class="form-control form-control-sm" name="Color" id="Color"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input v-model="Storage" class="form-control form-control-sm" name="Storage" id="Storage"
            ...
            <div class="col-lg-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" v-on:click="editproduct()" class="btn btn-outline-success">
                            <span class="fa fa-wrench"></span>
                        </button>
                        <button type="button" v-on:click="DeleteProduct(Produtoview.productId)" class="btn btn-outline-danger">
        ...
        methods: {
                ...
                if (!this.errors.length) {
                    ...
                    this.$http.post('http://localhost:65009/api/Product', prodcut)
                        .then(function(response) {
                                ...
                                this.$toaster.success('Product  = ' + prodcut.ProductName + ' Created Successfully.',
                                    { timeout: 3000 });
                            },
            ...
            DeleteProduct: function(Productid) {
                ...
                this.$http.delete('http://localhost:65009/api/Product?Productid=' + Productid)
                    .then(function(response) {
                            this.$toaster.success('Product with id = ' + Productid + ' Deleted Successfully.',
                                { timeout: 3000 });
                            this.isproductcreated = !this.isproductcreated;
                        },
                        function(errorresponse) {
...
<style scoped>
    ...
    .cardcutom { border: 2px solid whitesmoke; }
    ...
    .savebtn { text-align: -webkit-right; }

    .form-group { text-align: -webkit-auto }
