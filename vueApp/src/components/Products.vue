...
<div  id="Products">  
  <nav aria-label="breadcrumb container sticky-top"> 
      <div class="row  breadcrumb">
          <div class="col-6 ">
            <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#" v-on:click="GetProducts()"><span class="fa fa-home"></span> Home</a></li>
           <li class="breadcrumb-item" aria-current="page" v-on:click="FilterIphones()"><a href="#"><span class="fa fa-mobile"></span>Iphones</a></li>
            <li class="breadcrumb-item" aria-current="page"  v-on:click="FilterMackBook()"><a href="#"><span class="fa fa-laptop"></span>MackBook</a></li>
          </ol>
      </div>
...
<div class="alert alert-danger container"> <strong> <span class="fa fa-exclamation-triangle"></span> Server Info !</strong> 
<hr>
...
<ul class="list-group">
  ...
  <li class="list-group-item btn btn-sm btn-default">
      <input class="form-check-input" v-on:click="FilterByColor('Gold')" type="checkbox" value="" id="defaultCheck1"> Gold</li>
  <li class="list-group-item btn btn-sm btn-default">
      <input class="form-check-input"  v-on:click="FilterByColor('Sliver')" type="checkbox" value="" id="defaultCheck1"> Sliver</li>
  <li class="list-group-item btn btn-sm btn-default">
      <input class="form-check-input"  v-on:click="FilterByColor('Black')" type="checkbox" value="" id="defaultCheck1"> Black</li> 
  <li class="list-group-item btn btn-sm btn-default">
      <input class="form-check-input"  v-on:click="FilterByColor('Rose')" type="checkbox" value="" id="defaultCheck1"> Rose</li>
...
<ul class="list-group">
  ...
  <li class="list-group-item btn btn-sm btn-default"> 
      <input class="form-check-input" type="checkbox" value="" id="defaultCheck1">  0 To 20k  </li>
  <li class="list-group-item btn btn-sm btn-default">  
      <input class="form-check-input" type="checkbox" value="" id="defaultCheck1"> 20 To 40k </li>
   <li class="list-group-item btn btn-sm btn-default"> 
      <input class="form-check-input" type="checkbox" value="" id="defaultCheck1"> 40 To 1 Lac. </li>
...
<div class="row">
  <div class="col-12">
  <h4 v-if="emptycart" class="alert alert-info text-center"> <span class="fa fa-cart-plus"></span> Hi There seems your cart is empty. 
    please add some product to buy.Thank you.</h4>
    </div>
</div>
    ...
    methods:{
      ...
      GetProducts(){ 
       ...
       this.Products = [];
              ...
              .then(function(data){ 
              this.Products = data.body.slice(0,100); 
              this.Products = this.Products.filter(item => item.weight.toLowerCase() == "100.G".toLowerCase());
                 this.checkApiresponse(); 
              })   
      },
       FilterMackBook(){
          ...
          this.$http.get("http://localhost:65009/api/Product")
              .then(function(data){ 
              this.Products = data.body.slice(0,100); 
              this.Products = this.Products.filter(item => item.weight.toLowerCase() == "250.G".toLowerCase());
                this.checkApiresponse(); 
              })   
       ...
       FilterByColor(colorType){
          ...
          this.$http.get("http://localhost:65009/api/Product")
              .then(function(data){ 
              this.Products = data.body.slice(0,100); 
              this.Products = this.Products.filter(item => item.color.toLowerCase() == colorType.toLowerCase());
                this.checkApiresponse(); 
              })   
      ...
      greetuser(){
           this.$toaster.info('Thank you very much for visiting our website have Great day ahead', {timeout: 5000});
        ...
        console.log(toadd); 
               ...
               {  
                 ...
                 console.log(this.CartItems);
                  ...
                  setTimeout(() => {
                    this.$toaster.warning('Total Item(s) in cart  = [ '+this.ItemsIncart+' ]', {theme: 'Success', timeout: 3000});
                 }, 3000);
